...
bool box_msgs__msg__box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("box_msgs.msg._box.Box", full_classname_dest, 21) == 0);
  }
  box_msgs__msg__Box * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Box */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("box_msgs.msg._box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Box");

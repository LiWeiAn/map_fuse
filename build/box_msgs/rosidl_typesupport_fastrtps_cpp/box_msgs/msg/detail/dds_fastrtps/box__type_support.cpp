...
#include "box_msgs/msg/detail/box__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const box_msgs::msg::Box *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Box(full_bounded, 0);
}
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_box_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<box_msgs::msg::Box>()
{
  return &box_msgs::msg::typesupport_fastrtps_cpp::_Box__handle;
}

...
#ifndef CMR_MSGS__SRV__DETAIL__MAXON_CONTROLWORD__FUNCTIONS_H_
#define CMR_MSGS__SRV__DETAIL__MAXON_CONTROLWORD__FUNCTIONS_H_
...
/// Initialize srv/MaxonControlword message.
/**
...
/// Finalize srv/MaxonControlword message.
/**
...
/// Create srv/MaxonControlword message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cmr_msgs__srv__MaxonControlword_Request__init().
...
/// Destroy srv/MaxonControlword message.
/**
 * It calls
 * cmr_msgs__srv__MaxonControlword_Request__fini()
...
/// Initialize array of srv/MaxonControlword messages.
/**
...
/// Finalize array of srv/MaxonControlword messages.
/**
 * It calls
 * cmr_msgs__srv__MaxonControlword_Request__fini()
...
/// Create array of srv/MaxonControlword messages.
/**
 * It allocates the memory for the array and calls
 * cmr_msgs__srv__MaxonControlword_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MaxonControlword messages.
/**
 * It calls
 * cmr_msgs__srv__MaxonControlword_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cmr_msgs__srv__MaxonControlword_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cmr_msgs
...
/**
 * It calls
 * cmr_msgs__srv__MaxonControlword_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cmr_msgs
...
/**
 * It allocates the memory for the array and calls
 * cmr_msgs__srv__MaxonControlword_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cmr_msgs
...
/**
 * It calls
 * cmr_msgs__srv__MaxonControlword_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CMR_MSGS__SRV__DETAIL__MAXON_CONTROLWORD__FUNCTIONS_H_
